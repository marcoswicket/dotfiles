...
#touchpad disable if mouse is connected
bindsym $mod+Shift+t exec "bash ~/scripts/touchpad_toggle.sh"
...
# Lock screen
bindsym $mod+Shift+F1 exec --no-startup-id blurlock

# Autostart applications
exec --no-startup-id /usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1
exec xrandr --output HDMI1 --auto --output eDP1 --auto --output eDP1 --left-of HDMI1
